<?php
    ...
    // cek jika admin udah login, sehingga mendapatkan session admin
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Rara Bakery</a> 
            </div>
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li><a href="index.php?halaman=produk"><i class="fa fa-birthday-cake fa-3x"></i> Produk</a></li>	
